...
**Anchor:** `src/conversation/orchestrator/core.ts:1164` — `const rearmed = pause.awaitingVariant;`
...
**Anchor:** `src/conversation/orchestrator/core.ts:1453` — `case "sizer": {`
...
**Anchor:** `src/conversation/orchestrator/core.ts:2262` — `const enqueueIngest = (work: () => Promise<void>): Promise<void> => {`
...
**Anchor:** `src/conversation/orchestrator/core.ts:2304` — `if (active) return false;`
...
**Anchor:** `src/conversation/orchestrator/core.ts:2379` — `run.awaiting = { tag: "intent", buffer: "" };`
...
**Anchor:** `src/conversation/orchestrator/core.ts:2750` — `run.prototypeRound++;`
...
**Anchor:** `src/conversation/orchestrator/core.ts:2891` — `quotaPaused: () => run.quotaPause !== null || run.quotaPausePending,`
...
**Anchor:** `src/main.ts:161` — `type ActionInFlight = "none" | "submit" | "approve";`
...
**Anchor:** `src/main.ts:254` — `type Selection =`
...
**Anchor:** `src/main.ts:266` — `function openPath(): AbsPath | null {`
...
**Anchor:** `src/main.ts:337` — `function placeholderSelected(): boolean {`
...
**Anchor:** `src/main.ts:389` — `function pendingSurfaces(): PendingSurface[] {`
...
**Anchor:** `src/main.ts:578` — `pendingCount: pendingSurfaces().length,`
...
**Anchor:** `src/main.ts:590` — `submitInFlight: actionInFlight === "submit",`
